...
int main(int argc, char * argv [])
{
    ...
    std::shared_ptr<VTKRenderProcedure> tool_vtk_renderer = std::make_shared<ToolVTKRenderProcedure>(nh);
    stereo_window->left_procedures.push_back(tool_vtk_renderer);
    stereo_window->right_procedures.push_back(tool_vtk_renderer);
    // subscribe for image size changes, follow left image
    image_provider_left->image_aligned_subscribers.push_back(tool_vtk_renderer);
